                                      ...
                                      JS::Handle<jsid> id) const
{
  ...
  bool unused;
  return win->IndexedGetterOuter(index, unused);
}
...
already_AddRefed<nsIDOMWindow>
nsGlobalWindow::IndexedGetterOuter(uint32_t aIndex, bool& aFound)
{
  MOZ_ASSERT(IsOuterWindow());
...
nsGlobalWindow::IndexedGetter(uint32_t aIndex, bool& aFound)
{
  ...
  FORWARD_TO_OUTER(IndexedGetterOuter, (aIndex, aFound), nullptr);
  MOZ_CRASH();
}
